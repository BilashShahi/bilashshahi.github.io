...
![bloodhound-analysis-1](/assets/htb/forest/1.png)
...
![alt text](/assets/htb/forest/2.png)
...
```Shell
*Evil-WinRM* PS C:\> Get-ADGroupMember -Identity 'Exchange Windows Permissions'


distinguishedName : CN=tony,CN=Users,DC=htb,DC=local
name              : tony
objectClass       : user
objectGUID        : cc75b8a3-050b-4eb9-82a0-25648a7f7af5
SamAccountName    : tony
